/*
	Rollup.js v0.57.0
	Thu, 15 Mar 2018 07:10:25 GMT - commit 010b0e2fc56a3df7e186c359ca1688724943f776
...
for (var i = 0; i < chars.length; i++) {
    charToInteger$1[chars.charCodeAt(i)] = i;
}
...
var Graph = /** @class */ (function () {
    ...
    Graph.prototype.includeMarked = function (modules) {
        if (this.treeshake) {
            var addedNewNodes_1, treeshakingPass = 1;
            do {
        ...
        return Promise.all(entryModuleIds.map(function (entryId) { return _this.loadModule(entryId); })).then(function (entryModules) {
            ...
            if (!preserveModules) {
                ...
                orderedModules.forEach(function (module) {
                    ...
                    var curChunk = chunkModules_1[entryPointsHashStr];
                    if (curChunk) {
                        curChunk.push(module);
                    }
                    else {
                        chunkModules_1[entryPointsHashStr] = [module];
                    }
                });
                // create each chunk
                Object.keys(chunkModules_1).forEach(function (entryHashSum) {
                    var chunk = chunkModules_1[entryHashSum];
    ...
    Graph.prototype.analyseExecution = function (entryModules, preserveModules) {
        var _this = this;
